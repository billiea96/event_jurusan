                ...
                <table class="table table-bordered table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#{{ $mahasiswa->user->id }}">Edit</button></td>
                            <!-- Modal -->
                            <div id="{{ $mahasiswa->user->id }}" class="modal fade" role="dialog">
                                <div class="modal-dialog modal-lg">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-sm-12 table-responsive">
                                                    <form class="form-horizontal" id="formUpdate{{ $mahasiswa->user->id }}" action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST">
                                                        {{ method_field("PUT") }}
                                                        {!! csrf_field() !!}
                                                        <div class="col-sm-offset-10 col-sm-1"></div><br>
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label col-sm-5" for="username">Username:</label>
                                                                <div class="col-sm-5">
                                                                    <input type="text" class="form-control" name="username" id="username" placeholder="Username" value="{{ $mahasiswa->user->name }}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label col-sm-5" for="password">Password:</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label col-sm-5" for="email">Alamat Email:</label>
                                                                <div class="col-sm-5">
                                                                    <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="{{ $mahasiswa->user->email }}" required>
                                                                </div>
                                                            </div>
                                                            </fieldset>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label col-sm-5" for="nrp">NRP:</label>
                                                                <div class="col-sm-5">
                                                                    <input type="text" class="form-control" name="nrp" id="nrp" placeholder="NRP" value="{{ $mahasiswa->nrp }}" disabled required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label col-sm-5" for="namaLengkap">Nama Lengkap:</label>
                                                                <div class="col-sm-5">
                                                                    <input type="text" class="form-control" name="nama" id="namaLengkap" placeholder="Nama Lengkap Mahasiswa" value="{{ $mahasiswa->nama }}" required>
                                                                </div>
                                                            </div>
                                                            </fieldset>
                                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            <div class="col-sm-12">
                                                <div class="col-sm-offset-10 col-sm-1">
                                                    <input class="btn btn-success btn-md" type="submit" name="simpan" value="Simpan" form="formUpdate{{ $mahasiswa->user->id }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
